...
enum RedRHIFormatType {
    RED_RHI_FORMAT_TYPE_FLOAT,
    RED_RHI_FORMAT_TYPE_DOUBLE,
    RED_RHI_FORMAT_TYPE_INT32,
    RED_RHI_FORMAT_TYPE_INT16,
    RED_RHI_FORMAT_TYPE_UINT32,
    RED_RHI_FORMAT_TYPE_UINT16,

    RED_RHI_FORMAT_TYPE_COUNT
};
...
enum RedRHITextureFormat {
    RED_RHI_TEXTURE_FORMAT_R8,
    RED_RHI_TEXTURE_FORMAT_R8G8,
    RED_RHI_TEXTURE_FORMAT_R8G8B8,
    RED_RHI_TEXTURE_FORMAT_R8G8B8A8,
